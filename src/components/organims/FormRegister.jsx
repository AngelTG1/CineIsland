    ...
    return ( 
        <div>
          ...
          try {
            ...
            console.log(values);
            console.log("registrado exitosamente como estudiante")
            ...
            > {({ handleChange,errors, handleSubmit, isSubmitting }) => (
                <Form onSubmit={handleSubmit} className="form-registro">
                  ...
                  <WrapperInput   name="name"  type="text" onChange={handleChange} msn="Nombre" placeholder="Nombre" errors={errors.name} CNH1={errors.name == "Obligatorio" ? "error" : ""}/> 
                   ...
                   <WrapperInput   name="mail"  type="text" onChange={handleChange} msn="Correo electronico" placeholder="Dirección de correo electronico" errors={errors.email} CNH1={errors.mail == "Obligatorio" || errors.mail == "Por favor ingresa la direccion correctamente" ? "error" : ""} />
